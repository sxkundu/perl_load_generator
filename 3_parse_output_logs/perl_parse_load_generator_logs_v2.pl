...
my $Repository_Instance = "db2adm1p";
my $Repository_DB       = "ADM1P";
...
print "Type your password for $DB_User_ID\@ADM1P:";
...
example usage:
	...
	<script.pl> -u mrj3017 -d  /db2_temp/v1/db2edt1i/db2adm1s/perl_load_test/udp1q_output -r 2000 -t udp1q -s 'Description Testing CALL CWS_LW.SP_GET_LAB_RESULTS(?,?,?,?)' -c 100 -p 'SQL.*'
USAGE
}
...
=pod
===========
Input SQL {CALL CWS_MGP.SP_GET_LABS(?,?,?,?) with 77565448 2015-9-22 00:00:00 2016-6-18 00: 00:00 All Laboratory}
