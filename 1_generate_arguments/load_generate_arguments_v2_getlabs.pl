...
example usage:
    ...
    # Pass the userd id tu01945 or your choice, the prefix will be  JUNK for the outfiles in the directory that is hard coded, records read will be 1000 and batch size will be 100,
    # so 10 files files will be created in each directory.  
    <script>.pl -u tu01945 -p JUNK -r 1000 -b 100
